...
<body onload="dataMin(); dataMax();">
    ...
    <form action=" " method="POST" id="main-content">
        ...
        <div class="div-input-radio">
            <label for="materia">Conteúdo atrasado?</label>
            <input required id="atraso" type="radio" name="atraso" value="sim">Sim
            <input required checked id="atraso" type="radio" name="atraso" value="nao">Não
        </div>
        <div id="div-atrasoTxt"></div>
        <div class="div-input">
            <label for="observacoes">Observações:</label>
            <textarea placeholder="Ex.: Será usado na sala 42, incluir HDMI e cabo de rede." required id="observacoes" type="textarea" name="observacoes"></textarea>
        </div>

        <div class="div-input">
            <label for="calendario">Dia que usará o notebook:</label>
            <input type="date" value="<?php echo date('Y-m-d') ?>" id="diaAgendamento" min="" max="" name="date">
        </div>

        <div class="div-input">
            <label for="calendario">Periodo:</label> <!--Select que gera horarios dinamicamente-->
        ...
        <div class="div-input">
            <label for="calendario">Horario de retirada:</label>
        ...
        <div class="div-input">
            <label for="calendario">Horario de devolução:</label>
            <select id="select3" name="horarioDevolucao">
            </select>
        </div>

        <div class="div-input">
            <label for="materia">Quantidade: </label>
